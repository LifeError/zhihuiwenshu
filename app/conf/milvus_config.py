...
class MilvusConfig:
    ...
    milvus_user: str | None    # Milvus 用户
    milvus_password: str | None    # Milvus 用户密码
    chunks_collection: str | None   # 存储切片的集合名称
    entity_name_collection: str | None  # 预留-实体名称集合
    item_name_collection: str | None    # 存储文档对应实体类的集合名称
